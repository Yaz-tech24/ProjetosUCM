...
function layout(nomePlataforma, corPrimaria, corDestaque, conteudoHtml) {
  return `<!DOCTYPE html>
...
async function enviarBoasVindas({ to, nome, nomePlataforma, corPrimaria, corDestaque }) {
  return enviarEmail({
    to,
...
async function enviarRecuperacaoPassword({ to, nome, link, nomePlataforma, corPrimaria, corDestaque }) {
  return enviarEmail({
    to,
...
async function enviarModeracaoMaterial({ to, nome, titulo, aprovado, nomePlataforma, corPrimaria, corDestaque }) {
  return enviarEmail({
    to,
