...
const Layout = ({ usuarioLogado, onLogout }) => {
  ...
  if (!usuarioLogado) {
    return (
      <div className="h-screen flex items-center justify-center" style={{ background: "#f0f5ff" }}>
        <div className="flex flex-col items-center gap-3">
          <div
            className="w-12 h-12 rounded-full border-4 animate-spin"
            style={{ borderColor: "rgba(13,37,74,0.15)", borderTopColor: "#ffd700" }}
          />
          <p style={{ fontSize: 13, fontWeight: 600, color: "rgba(13,37,74,0.50)" }}>A redirecionar...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex min-h-screen font-sans" style={{
      background: `
        radial-gradient(ellipse at 8%  8%,  rgba(255,215,0,.08)    0%, transparent 36%),
        radial-gradient(ellipse at 92% 92%, rgba(0,51,102,.08)     0%, transparent 36%),
        radial-gradient(ellipse at 55% 45%, rgba(168,209,255,.06)  0%, transparent 54%),
        #f0f5ff
      `,
      color: "#0f172a",
    }}>
      ...
      <aside
        ...
        style={{
          background: "linear-gradient(-45deg, #020b18, #04122e, #071832, #0a1d38)",
          backgroundSize: "400% 400%",
          animation: "aurora-sidebar 14s ease infinite",
          boxShadow: "8px 0 48px rgba(2,11,24,0.45)",
        }}
      >
        <style>{`
          ...
          @keyframes glow-logo-small {
            0%,100% { box-shadow: 0 0 24px rgba(255,215,0,0.45); }
            50%      { box-shadow: 0 0 42px rgba(255,215,0,0.75), 0 0 70px rgba(255,215,0,0.25); }
          }
        ...
        <div
          ...
          style={{ background: "linear-gradient(180deg, transparent, rgba(255,215,0,0.6) 30%, rgba(255,215,0,0.3) 70%, transparent)" }}
        />

        {/* Barra dourada topo */}
        <div
          className="h-[3px] shrink-0"
          style={{ background: "linear-gradient(90deg, transparent, #c9a800, #ffd700, #ffe88a, #ffd700, #c9a800, transparent)" }}
        />
        ...
        <div className="relative px-7 pt-7 pb-6 shrink-0" style={{ borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
          <div className="flex items-center gap-4">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #c9a800 0%, #ffd700 55%, #ffe88a 100%)",
                color: "#04122e",
            ...
            <div>
              <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.38em", color: "rgba(168,209,255,0.60)", textTransform: "uppercase" }}>UCM</p>
            ...
            return (
              <button
                ...
                style={active ? {
                  ...
                  color: "#04122e", fontWeight: 800,
                  boxShadow: "0 6px 24px rgba(255,215,0,0.40)",
              ...
              >
                <Icon size={19} />
                <span>{label}</span>
                {active && <span className="ml-auto w-2 h-2 rounded-full" style={{ background: "rgba(4,18,46,0.40)" }} />}
              </button>
            );
          })}
            ...
            <>
              ...
              <button
                ...
                style={isActive('/admin') ? {
                  background: "rgba(255,255,255,0.95)", color: "#0d254a", fontWeight: 800,
                  boxShadow: "0 4px 16px rgba(2,11,24,0.25)",
        ...
        <div className="relative px-5 pb-7 pt-4 space-y-3 shrink-0" style={{ borderTop: "1px solid rgba(255,255,255,0.07)" }}>
          ...
          >
            <div
              ...
              style={{ background: "linear-gradient(135deg, #c9a800, #ffd700, #ffe88a)", color: "#04122e", boxShadow: "0 4px 14px rgba(255,215,0,0.40)" }}
            >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.25em", color: "rgba(168,209,255,0.50)", fontWeight: 600 }}>
      ...
      <main className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header
          ...
          style={{
            ...
            borderBottom: "1px solid rgba(13,37,74,0.08)",
            boxShadow: "0 1px 24px rgba(13,37,74,0.06)",
          }}
        >
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div>
              ...
              <h2 className="mt-1.5 leading-tight" style={{ fontSize: 26, fontWeight: 900, color: "#04122e", letterSpacing: "-0.02em" }}>
                Bem-vindo,{' '}
                <span style={{ background: "linear-gradient(135deg, #04122e, #0d254a)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            ...
            <div className="flex items-center gap-3">
              ...
              <form onSubmit={handleSearch} className="flex items-center">
                <div
                  ...
                  style={{ background: "rgba(255,255,255,0.80)", border: "1.5px solid rgba(13,37,74,0.10)", boxShadow: "0 2px 12px rgba(13,37,74,0.05)" }}
                >
              ...
              <div className="relative" ref={notifRef}>
                <button
                  ...
                  style={{ background: notifOpen ? "#0d254a" : "rgba(255,255,255,0.80)", border: "1.5px solid rgba(13,37,74,0.10)", boxShadow: "0 2px 12px rgba(13,37,74,0.05)", color: notifOpen ? "#ffd700" : "#64748b" }}
                  onMouseEnter={e => (e.currentTarget.style.background = "#0d254a", e.currentTarget.style.color = "#ffd700")}
                ...
                {notifOpen && (
                  <div className="absolute right-0 top-14 z-50 w-80 rounded-[20px] overflow-hidden animate-scale-in"
                    style={{ background: "#fff", border: "1px solid rgba(13,37,74,0.10)", boxShadow: "0 20px 60px rgba(13,37,74,0.18)" }}>
                    {/* Header */}
                    <div className="flex items-center justify-between px-5 py-4"
                      style={{ borderBottom: "1px solid rgba(13,37,74,0.07)", background: "linear-gradient(135deg,#04122e,#0d254a)" }}>
                    ...
                    <div className="py-2">
                      {notifLoading ? (
                        <div className="flex justify-center py-6">
                          <div className="w-6 h-6 rounded-full border-[3px] animate-spin" style={{ borderColor: "rgba(13,37,74,0.10)", borderTopColor: "#0d254a" }} />
                        </div>
                      ) : notifMats.length === 0 ? (
                        ...
                        >
                          <div style={{ width: 34, height: 34, borderRadius: 10, flexShrink: 0, display: "grid", placeItems: "center",
                            ...
                            {m.tipo === 'Vídeo' ? <PlayCircle size={15} style={{ color: "#0d254a" }} /> : <FileText size={15} style={{ color: "#be123c" }} />}
                          </div>
                          <div className="min-w-0 flex-1">
                            <p className="truncate" style={{ fontSize: 13, fontWeight: 700, color: "#04122e" }}>{m.titulo}</p>
                            <p style={{ fontSize: 11, color: "#94a3b8" }}>{m.cadeira}</p>
                          </div>
                        </button>
                      ))}
                    </div>
                    <div className="px-4 py-3" style={{ borderTop: "1px solid rgba(13,37,74,0.07)" }}>
                      <button onClick={() => { navigate('/repositorio'); setNotifOpen(false); }}
                        className="w-full rounded-xl py-2 text-xs font-bold transition-all"
                        style={{ background: "#f0f5ff", color: "#0d254a" }}
        ...
        <div className="flex-1 overflow-auto p-8" style={{
          background: `
            radial-gradient(ellipse at 18% 18%, rgba(30,95,224,.055) 0%, transparent 48%),
            radial-gradient(ellipse at 82% 82%, rgba(13,37,74,.045)  0%, transparent 48%),
            radial-gradient(ellipse at 50% 50%, rgba(168,209,255,.035) 0%, transparent 62%),
            transparent
          `
        }}>
          <Outlet />
