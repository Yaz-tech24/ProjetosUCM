...
const StatCard = ({ icon: Icon, label, value, iconBg, glow, delay }) => (
  ...
  >
    <div className="flex items-center justify-between">
      ...
      <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.28em", color: "rgba(168,209,255,0.55)", textTransform: "uppercase" }}>
        {label}
      </span>
    </div>
...
const MiniCard = ({ m, onClick }) => (
  <article
    ...
    style={{
      ...
      boxShadow: "0 2px 14px rgba(13,37,74,0.06)",
    }}
    onMouseEnter={e => (e.currentTarget.style.transform = "translateY(-3px)", e.currentTarget.style.boxShadow = "0 10px 36px rgba(13,37,74,0.14), 0 0 0 1px rgba(255,215,0,0.12)")}
    onMouseLeave={e => (e.currentTarget.style.transform = "", e.currentTarget.style.boxShadow = "0 2px 14px rgba(13,37,74,0.06)")}
  >
    <div
    ...
    >
      {m.tipo === 'Vídeo'
        ? <PlayCircle size={20} style={{ color: "#0d254a" }} />
        : <FileText   size={20} style={{ color: "#be123c" }} />}
    </div>
    <div className="min-w-0 flex-1">
      <p className="text-sm font-bold truncate transition-colors group-hover:text-[#0d254a]" style={{ color: "#0f172a" }}>
        {m.titulo}
      </p>
  ...
  const statCards = [
    {
      ...
      iconBg: "linear-gradient(135deg, #04122e, #0d254a)",
      glow: "0 6px 20px rgba(4,18,46,0.40)", delay: "0.1s",
    },
    {
      icon: Users, label: "Estudantes",
      value: stats?.total_utilizadores ?? '…',
      iconBg: "linear-gradient(135deg, #0a3d62, #1e5fe0)",
      glow: "0 6px 20px rgba(30,95,224,0.35)", delay: "0.15s",
    },
    {
    ...
    <div className="grid gap-8 animate-fade-in">
      ...
      <section
        ...
        style={{
          ...
          boxShadow: "0 28px 90px rgba(2,11,24,0.55)",
          padding: "3rem",
        }}
      >
        <style>{`
        ...
        <div className="absolute inset-0 pointer-events-none" style={{
          background: "radial-gradient(ellipse at 22% 28%, rgba(255,215,0,0.13) 0%, transparent 55%)",
        }} />
        ...
        <div className="relative grid gap-10 lg:grid-cols-[1.6fr_1fr] items-center">
          <div className="space-y-6">
            <div
              ...
              style={{ background: "rgba(255,255,255,0.10)", border: "1px solid rgba(255,255,255,0.16)", letterSpacing: "0.32em", color: "rgba(255,215,0,0.90)", backdropFilter: "blur(8px)" }}
            >
              <Sparkles size={14} style={{ color: "#ffd700" }} /> SmartHub UCM
            </div>
            ...
            <p style={{ fontSize: 17, color: "rgba(168,209,255,0.85)", lineHeight: 1.65, maxWidth: 440 }}>
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              <button
                ...
                style={{ background: "linear-gradient(135deg, #c9a800, #ffd700, #ffe88a)", color: "#04122e", padding: "12px 28px", boxShadow: "0 8px 30px rgba(255,215,0,0.50), inset 0 1px 0 rgba(255,255,255,0.35)" }}
                ...
                onMouseLeave={e => (e.currentTarget.style.transform = "", e.currentTarget.style.boxShadow = "0 8px 30px rgba(255,215,0,0.50), inset 0 1px 0 rgba(255,255,255,0.35)")}
              >
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        {[
          { icon: Library,       label: "Repositório",   desc: "Materiais aprovados", path: "/repositorio", bg: "linear-gradient(135deg,#04122e,#0d254a)", glow: "rgba(13,37,74,0.40)" },
          { icon: MessageCircle, label: "Chat",           desc: "Turma em tempo real", path: "/chat",        bg: "linear-gradient(135deg,#0a3d62,#1e5fe0)", glow: "rgba(30,95,224,0.35)" },
          ...
          <button
            ...
            style={{
              ...
              WebkitBackdropFilter: "blur(12px)",
              border: "1px solid rgba(13,37,74,0.08)",
              boxShadow: "0 4px 24px rgba(13,37,74,0.06)",
            }}
            onMouseEnter={e => (e.currentTarget.style.transform = "translateY(-3px)", e.currentTarget.style.boxShadow = `0 12px 40px ${glow}`)}
            onMouseLeave={e => (e.currentTarget.style.transform = "", e.currentTarget.style.boxShadow = "0 4px 24px rgba(13,37,74,0.06)")}
          >
            ...
            <div className="min-w-0">
              <p style={{ fontSize: 15, fontWeight: 800, color: "#04122e" }}>{label}</p>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            {favMateriais.length === 0 ? (
              <div className="rounded-[20px] p-5 text-center" style={{ background: "#fff", border: "1px solid rgba(13,37,74,0.07)" }}>
              ...
              <div className="space-y-2">
                {meusMateriais.slice(0, 4).map(m => (
                  <div
                    ...
                    style={{ background: "#fff", border: "1px solid rgba(13,37,74,0.07)" }}
                  >
                    <div className="min-w-0 flex-1">
...
/* Auxiliares de UI */
const SectionHeader = ({ title, icon: Icon, color = "#0d254a", onMore, small }) => (
  <div className="flex items-center justify-between">
    <h2
      className="flex items-center gap-2"
      style={{ fontSize: small ? 16 : 20, fontWeight: 900, color: "#04122e", letterSpacing: "-0.01em" }}
    >
...
const EmptyState = ({ text }) => (
  <div
    ...
    style={{ border: "2px dashed rgba(13,37,74,0.10)", background: "#fff" }}
  >
